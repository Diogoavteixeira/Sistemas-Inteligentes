...
class EightPuzzle:
    ...
    def count_inversions(self, board):
        """Conta inversões na lista do tabuleiro (usado para verificação de solubilidade)."""
    ...
    def move(self, direction):
        ...
        Move uma peça na direção especificada.
         - 'up': se o espaço vazio não estiver na última linha, troca com a peça abaixo.
         - 'down': se o espaço vazio não estiver na primeira linha, troca com a peça acima.
         - 'left': se o espaço vazio não estiver na última coluna, troca com a peça à direita.
         - 'right': se o espaço vazio não estiver na primeira coluna, troca com a peça à esquerda.
        """
        x, y = self.find_empty()
        moved = False
    ...
    def board_to_state(self, board):
        """Converte o tabuleiro (lista de listas) numa tupla de tuplas (hashable)."""
    ...
    def auto_solve_astar(self, heuristic):
        """
        Usa A* para achar a sequência ótima de movimentos partindo do tabuleiro atual (inicial)
        até o tabuleiro alvo. Recebe a função heurística a ser utilizada.
